...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-6 md:px-12 md:py-8 transition-all duration-500 ease-in-out bg-background/80 backdrop-blur-sm border-b ${scrolled ? "border-border" : "border-transparent"}`}
    >
      <Link
        href={"/"}
